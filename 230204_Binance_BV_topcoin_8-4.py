...
# 오늘 수익 = 현재 position 수익 + 오늘 확정 수익
day_PNL = sum_PNL + BV_daily_month_profit["daily"]
# 월 수익 = 현재 position 수익 + 어제까지 월 확정 수익 + 오늘 확정 수익
month_PNL = sum_PNL + BV_daily_month_profit["month"] + BV_daily_month_profit["daily"]
