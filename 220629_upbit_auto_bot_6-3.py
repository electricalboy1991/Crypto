...
print("Remain Money:",float(balance['USDT']['free'])) #남은 돈
...
#포지션을 잡을 때는 숏이든 롱이든 무조건 양수로 잡아야 하기 때문
abs_amt = abs(amt)
...
if amt == 0:
    ...
    if ma5 > ma20 and ma5_before3 < ma5_before2 and ma5_before2 > ma5 and rsi14 >= 35.0:
        ...
        #지정가 주문을 걸어놨는데, 주문 체결이 안됐을 수 도 있음. 그래서 이전에 들어간건 다 취소해주는 거야.
        #물타거나, 수익화 하거나, 손절을 해야하거나 할 때, 이전 주문이 남아 있으면 애매해짐.
